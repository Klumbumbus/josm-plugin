...
/**
 * Displays the deprecated message.
 *
 * @author Beata
 * @version $Revision$
 */
class PhotoPanel extends JPanel {
    ...
    PhotoPanel() {
        ...
        add(GuiBuilder.buildTextArea(GuiConfig.getInstance().getDeprecatedTxt(), getBackground(), false,
                getFont().deriveFont(Font.BOLD, GuiBuilder.FONT_SIZE_12)), BorderLayout.CENTER);
    }
}